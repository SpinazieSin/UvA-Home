...
def move_head(headxpos, headypos, im_width, im_height):
    ...
    if headspotted:
        print("head is spotted.")
        # turning head
        print("width/3: " + str(width/3))
        print("headxpos: " + str(headxpos))
        print("headypos: " + str(headypos))
        ...
        motionProxy.stiffnessInterpolation("Head", 0.0, 0.4)
