#! usr/bin/python
#
# file:				geometric_median
# author:			Mark Wojtowicz
# date:				07-04-2016
# source:			https://github.com/mrwojo/geometric_median
# dependencies:		Numpy, Scipy
# description:		Computes the geometric median of a list of points
# public functions:	geometric_median
#						Computes the geometric_median of a given dataset
...
def geometric_median(points, method='auto', options={}):
    ...
    return list(_methods[method](points, options))
