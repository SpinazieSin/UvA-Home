...
def rescale_boxes(current_shape, anno, target_height, target_width):
    ...
    for r in anno.rects:
        # I added these checks because the asserts were causing errors,
        # I don't know why the values are equal sometimes.. but this fixes it
        if r.x1 > r.x2:
            tmp1 = r.x1
            tmp2 = r.x2
            r.x1 = tmp2
